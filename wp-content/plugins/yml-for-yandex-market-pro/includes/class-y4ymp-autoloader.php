 ...
 * 
 * - `class-[PREFIX]-[CLASS-NAME].php` - code in the file: `class Y4YMP_My_Name {...}`;
 * - `trait-[PLUGIN_PREFIX]-t-[TRAIT-NAME].php` - code in the file: `trait Y4YMP_T_My_Name {...}`;
 * - `interface-[PLUGIN_PREFIX]-i-[INTERFACE-NAME].php` - code in the file: `interface Y4YMP_I_My_Name`.
 * 
 * Usage example: `new Y4YMP_Autoload( Y4YMP_PLUGIN_DIR_PATH, 'Y4YMP' )`;
 *
 * @since      0.1.0
 * @package    Y4YMP
 * @subpackage Y4YMP/includes
 ...
 */
class Y4YMP_Autoloader {

	/**
	 * The path to the classmap file.
	 *  
	 * Example: `/home/p135/www/site.ru/wp-content/plugins/yml-for-yandex-market-pro/classmap.php`.
	 * 
	 * @var string
	 */
	private $map_file;
	 ...
	 * The plugin dir path.
	 * 
	 * Example: `/home/p135/www/site.ru/wp-content/plugins/yml-for-yandex-market-pro/`.
	 * 
	 * @var string
	 */
	private $plugin_dir_path = Y4YMP_PLUGIN_DIR_PATH;
	 ...
	 * 
	 * @return string Example: `/home/p135/www/site.ru/wp-content/plugins/yml-for-yandex-market-pro/`.
	 */
