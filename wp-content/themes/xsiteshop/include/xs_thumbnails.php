		...
		public function fill_image_column( $string, $column_name, $term_id ){
			if( $image_id = get_term_meta( $term_id, self::$meta_key, 1 ))
				if($column_name == 'image')
					$string = '<img src="'. wp_get_attachment_image_url( $image_id, 'thumbnail' ) .'" alt="" style="border-radius:4px;max-width:50px;max-height:50px;width:auto;height:auto;" />';
